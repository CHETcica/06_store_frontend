...
function ProductList() {
  ...
  const updateProduct = () => {
    axios.get("https://store-backend-chet008.herokuapp.com/api/products").then((response) => {
  ...
  const deleteProduct = (product) => {
    swal({
      ...
      if (willDelete) {
        axios
          .delete("https://store-backend-chet008.herokuapp.com/api/products/" + product._id)
          .then((response) => {
